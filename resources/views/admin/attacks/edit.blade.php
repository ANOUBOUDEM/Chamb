        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
                ...
                <div class="mt-5 mb-4 ml-5">
                    <form action="{{ route('attacks.update', $attack->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" value="{{ $attack->name }}" name="name" id="name" autocomplete="name" class="block w-full
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" value="{{ $attack->damage }}" name="damage" id="damage" autocomplete="damage" class="block w-full rounded-md border-0
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <textarea name="description" id="description" class="block w-full rounded-md border-0
                                     py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2
                                      focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" rows="3" cols="3" required>
                                        {{ $attack?->description }}
                                    </textarea>
                                </div>
                            </div>
