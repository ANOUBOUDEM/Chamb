    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
                ...
                @endif
                <a href="{{ route('types.index') }}" class="px-4 py-2 mx-4 my-3 mt-3 font-bold text-white
                bg-blue-500 rounded hover:bg-blue-700">{{ __('Types') }}</a>
                    ...
                    <form action="{{ route('types.update', $type->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" name="name" value="{{ $type->name }}" id="name" autocomplete="name" class="block w-full
                            ...
                            <div class="sm:col-span-3">
                                <label for="color" class="block text-sm font-medium leading-6 text-gray-900">{{ __('Color') }}</label>
                                <div class="mt-2">
                                    <input type="text" name="color" id="color" value="{{ $type->color }}" autocomplete="color" class="block w-full rounded-md border-0
